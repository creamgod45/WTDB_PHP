...
function update_order() {
    $(".order_item").html("<tr class=\"table-info\"><th scope=\"row\"></th><td>總共</td><td id=\"count_unit\">"+total_unit+"</td><td id=\"count_money\">$"+total_money+"</td></tr>");
    var string = "";
...
function orderchecker(){
    var val = document.getElementById("orderlist").value;
    if(val == ""){return false;}
}
